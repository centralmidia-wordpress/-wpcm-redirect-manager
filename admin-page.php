...
// Start the plugin
WPCM_Redirect_Manager();
root@dnpxtec:/var/www/local.rd5.com.br/htdocs/wp-content/plugins/wpcm-redirect-manager# ls
css  js  languages  templates  wpcm-redirect-manager.php
root@dnpxtec:/var/www/local.rd5.com.br/htdocs/wp-content/plugins/wpcm-redirect-manager# cat admin-style.css
cat: admin-style.css: No such file or directory
root@dnpxtec:/var/www/local.rd5.com.br/htdocs/wp-content/plugins/wpcm-redirect-manager# cd css
root@dnpxtec:/var/www/local.rd5.com.br/htdocs/wp-content/plugins/wpcm-redirect-manager/css# cat admin-style.css
/* css/admin-style.css */
.wpcm-redirect-table {
    margin-top: 20px;
}
...
root@dnpxtec:/var/www/local.rd5.com.br/htdocs/wp-content/plugins/wpcm-redirect-manager/css# cd ..
root@dnpxtec:/var/www/local.rd5.com.br/htdocs/wp-content/plugins/wpcm-redirect-manager# cd js
root@dnpxtec:/var/www/local.rd5.com.br/htdocs/wp-content/plugins/wpcm-redirect-manager/js# nano admin-script.js
root@dnpxtec:/var/www/local.rd5.com.br/htdocs/wp-content/plugins/wpcm-redirect-manager/js# cat admin-script.js
// js/admin-script.js
jQuery(document).ready(function($) {
    // Confirmar exclusão de redirecionamento
    $('.wpcm-delete-redirect').on('click', function(e) {
        if (!confirm(wpcmRedirect.deleteConfirm)) {
            e.preventDefault();
        }
    });

    // Validar formulário antes do envio
    $('#wpcm-redirect-form').on('submit', function(e) {
        var fromUrl = $('#from_url').val();
        var toUrl = $('#to_url').val();

        if (!fromUrl || !toUrl) {
            e.preventDefault();
            alert(wpcmRedirect.fieldsRequired);
            return false;
        }
    ...
    $('.wpcm-copy-url').on('click', function(e) {
        e.preventDefault();
        var url = $(this).data('url');
        navigator.clipboard.writeText(url).then(function() {
            alert(wpcmRedirect.urlCopied);
        });
    });
});
